...
import { getDefaultHeaderHeight, SafeAreaProviderCompat, Background } from '@react-navigation/elements';
...
export default class CardStack extends React.Component {
  ...
  render() {
    const {
      ...
      detachInactiveScreens = Platform.OS === 'web' ? true : shouldUseActivityState !== null && shouldUseActivityState !== void 0 ? shouldUseActivityState : false
    } = this.props;
    const {
      scenes,
      layout,
