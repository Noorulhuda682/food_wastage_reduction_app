...
class CardStack extends React.Component {
  ...
  render() {
    const {
      ...
      detachInactiveScreens = _reactNative.Platform.OS === 'web' ? true : _Screens.shouldUseActivityState !== null && _Screens.shouldUseActivityState !== void 0 ? _Screens.shouldUseActivityState : false
    } = this.props;
    const {
      scenes,
      layout,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, isFloatHeaderAbsolute ? null : floatingHeader, /*#__PURE__*/React.createElement(_Screens.MaybeScreenContainer, {
      ...
      const {
        ...
        headerTintColor,
        cardShadowEnabled,
        cardOverlayEnabled = _reactNative.Platform.OS !== 'ios' || mode === 'modal',
        cardOverlay,
        cardStyle,
        animationEnabled,
