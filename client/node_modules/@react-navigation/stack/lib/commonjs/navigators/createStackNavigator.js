...
function StackNavigator({
  ...
  (0, _warnOnce.default)(headerMode && headerMode !== 'none', `Stack Navigator: 'headerMode' is moved to 'options'. Moved it to 'screenOptions' to keep current behavior.`);
  const {
    state,
    descriptors,
    navigation
    ...
    defaultScreenOptions: ({
      ...
      headerMode: headerMode && headerMode !== 'none' ? headerMode : rest.mode !== 'modal' && _reactNative.Platform.OS === 'ios' && options.header === undefined ? 'float' : 'screen',
