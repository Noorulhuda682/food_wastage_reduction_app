...
var _ScreenFallback = _interopRequireDefault(require("./ScreenFallback"));
  ...
  const renderSceneContent = () => {
    return (
      ...
      React.createElement(_reactNativeScreens.ScreenContainer, {
        ...
        return /*#__PURE__*/React.createElement(_ScreenFallback.default, {
          key: route.key,
...
function DrawerView({
  ...
  return /*#__PURE__*/React.createElement(_native.NavigationHelpersContext.Provider, {
    value: navigation
  }, /*#__PURE__*/React.createElement(_elements.SafeAreaProviderCompat, null, /*#__PURE__*/React.createElement(GestureHandlerWrapper, {
    style: styles.content
